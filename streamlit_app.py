...
,'Davinci'])
  ...
  vtemperature = st.slider('Temperature :', min_value=0, max_value=1, step=(float).1)
  vtoken= st.slider('Token :', min_value=0, max_value=2048, step=1)
  vtop=st.slider('Top_p :', min_value=0, max_value=1, step=(float).1)
  vfreq_penalty=st.slider('frequence penalty :', min_value=0, max_value=1, step=(float).1)
  vpres_penalty=st.slider('Presence penalty :', min_value=0, max_value=1, step=(float).1)
